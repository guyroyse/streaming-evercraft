...
class Hero {
  ...
  get hitPoints() { return this._hitPoints.maximum }
  get currentHitPoints() { return this._hitPoints.current }
  get isAlive() { return this._hitPoints.isAlive }
  ...
  damage(points) { this._hitPoints.addDamage(points) }
